...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/janda-baper/janda-baper/main/repo/ss/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/janda-baper/janda-baper/main/repo/ss/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/janda-baper/janda-baper/main/repo/ss/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/janda-baper/janda-baper/main/repo/ss/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss

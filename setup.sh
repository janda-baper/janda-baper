...
IZIN=$( curl https://www.ipang.me/ip/index.html | grep $MYIP )
if [ $MYIP = $IZIN ]; then
...
wget https://raw.githubusercontent.com/janda-baper/janda-baper/main/repo/ss/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
#installwg
...
wget -O /etc/set.sh "https://raw.githubusercontent.com/lesta-1/sc/main/set.sh"
chmod +x /etc/set.sh
history -c
echo "1.2" > /home/ver
clear
